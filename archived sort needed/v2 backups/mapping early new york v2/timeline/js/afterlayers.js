            ...
            afterMap.on('mousemove', 'karl_long_island-right', function (e) {
				...
				if (e.features.length > 0) {
                    if (hoveredKarlIdRight) {
                        afterMap.setFeatureState(
                            { source: 'karl_long_island-right', sourceLayer: 'karl_reduced_temp-1t5hcx', id: hoveredKarlIdRight},
                            { hover: false }
                        );
                    }
					//console.log(e.features[0]);
            ...
            afterMap.on('mouseenter', 'settlements-right', function (e) {
				...
				if (e.features.length > 0) {
                    if (hoveredSettlementsIdRight) {
                        afterMap.setFeatureState(
                            { source: 'settlements-right', sourceLayer: 'locations_layer_nahc-930jdy', id: hoveredSettlementsIdRight},
                            { hover: false }
                        );
                    }
