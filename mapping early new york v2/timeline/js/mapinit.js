						...
						if(layer_view_flag) {
							if(karl_layer_view_id == event.features[0].id) {
								if(karl_layer_view_flag) {
									...
									//*A#
							        afterMap.setFeatureState(
                                        { source: 'karl_long_island-right-highlighted', sourceLayer: 'karl_long_island_processed-2i6o24', id: karl_layer_view_id},
                                        { hover: false }
                                    );
									beforeMap.setFeatureState(
                                        { source: 'karl_long_island-left-highlighted', sourceLayer: 'karl_long_island_processed-2i6o24', id: karl_layer_view_id},
                                        { hover: false }
                                    );
							    ...
							    afterMap.setFeatureState(
                                    { source: 'karl_long_island-right-highlighted', sourceLayer: 'karl_long_island_processed-2i6o24', id: event.features[0].id},
                                    { hover: true }
                                );
								beforeMap.setFeatureState(
                                    { source: 'karl_long_island-left-highlighted', sourceLayer: 'karl_long_island_processed-2i6o24', id: karl_layer_view_id},
							    ...
							    beforeMap.setFeatureState(
                                    { source: 'karl_long_island-left-highlighted', sourceLayer: 'karl_long_island_processed-2i6o24', id: event.features[0].id},
                                    { hover: true }
                                );
                                afterHighMapKarlPopUp.setLngLat(event.lngLat).setHTML(highPopUpHTML);
								if(!afterHighMapKarlPopUp.isOpen()) afterHighMapKarlPopUp.addTo(afterMap);
